...
public protocol W3WAddressValidatorProtocol {
  ...
  func search(near: String, completion: @escaping  ([W3WValidatorNode], W3WAddressFinderError?) -> ())
  ...
  func list(from: W3WValidatorNodeList, completion: @escaping  ([W3WValidatorNode], W3WAddressFinderError?) -> ())
  ...
  func info(for: W3WValidatorNodeLeaf, completion: @escaping (W3WValidatorNodeLeafInfo?, W3WAddressFinderError?) -> ())
}
